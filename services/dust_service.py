...
# AQI level descriptions based on US AQI / PM2.5 (μg/m³) standards
# Reference: US EPA AQI breakpoints for PM2.5
AQI_LEVELS = [
    {"max": 12.0, "level": "ดี", "color": "🟢", "advice": "คุณภาพอากาศดี ไม่มีความเสี่ยงต่อสุขภาพ สามารถทำกิจกรรมกลางแจ้งได้ตามปกติ"},
    {"max": 35.4, "level": "ปานกลาง", "color": "🟡", "advice": "กลุ่มเสี่ยง (ผู้ป่วยโรคทางเดินหายใจ/หัวใจ เด็ก ผู้สูงอายุ) ควรลดกิจกรรมกลางแจ้งที่ใช้แรงมาก"},
    {"max": 55.4, "level": "เริ่มมีผลกระทบต่อกลุ่มเสี่ยง", "color": "🟠", "advice": "ประชาชนทั่วไปและกลุ่มเสี่ยงอาจมีอาการระคายเคืองทางเดินหายใจ ควรลดกิจกรรมกลางแจ้ง"},
    {"max": 150.4, "level": "มีผลกระทบต่อสุขภาพ", "color": "🔴", "advice": "ทุกคนอาจได้รับผลกระทบต่อหัวใจและปอด ควรหลีกเลี่ยงกิจกรรมกลางแจ้ง สวมหน้ากาก N95"},
    {"max": 250.4, "level": "มีผลกระทบต่อสุขภาพมาก", "color": "🟣", "advice": "ประชาชนทั่วไปได้รับผลกระทบชัดเจน กลุ่มเสี่ยงควรงดกิจกรรมกลางแจ้ง สวมหน้ากาก N95 ตลอดเวลา"},
    {"max": 999, "level": "อันตราย", "color": "🟤", "advice": "เป็นอันตรายต่อสุขภาพทุกคน งดกิจกรรมกลางแจ้งทุกชนิด ปิดประตูหน้าต่าง ใช้เครื่องฟอกอากาศ"},
]
