...
# AQI level descriptions based on Thai standard (Air4Thai / กรมควบคุมมลพิษ)
AQI_LEVELS = [
    {"max": 15.0, "level": "ดีมาก", "color": "🔵", "advice": "คุณภาพอากาศดีมาก ประชาชนทุกคนสามารถดำเนินชีวิตได้ตามปกติ"},
    {"max": 25.0, "level": "ดี", "color": "🟢", "advice": "คุณภาพอากาศดี สามารถทำกิจกรรมกลางแจ้งได้ตามปกติ"},
    {"max": 37.5, "level": "ปานกลาง", "color": "🟡", "advice": "ลดระยะเวลาการทำกิจกรรมกลางแจ้งที่ใช้แรงมาก กลุ่มเสี่ยงควรสวมหน้ากากป้องกันตนเอง หากมีอาการผิดปกติให้รีบปรึกษาแพทย์"},
    {"max": 75.0, "level": "เริ่มมีผลกระทบต่อสุขภาพ", "color": "🟠", "advice": "สวมหน้ากากป้องกันฝุ่น PM2.5 จำกัดระยะเวลาทำกิจกรรมกลางแจ้ง สังเกตอาการผิดปกติ เช่น ไอ หายใจลำบาก ระคายเคืองตา กลุ่มเสี่ยงควรหลีกเลี่ยงกิจกรรมกลางแจ้ง"},
    {"max": 999, "level": "มีผลกระทบต่อสุขภาพ", "color": "🔴", "advice": "งดกิจกรรมกลางแจ้ง ถ้าจำเป็นต้องออกข้างนอกควรสวมหน้ากากป้องกันฝุ่น PM2.5 หากมีอาการผิดปกติให้รีบไปพบแพทย์ ผู้มีโรคประจำตัวควรอยู่ในพื้นที่ปลอดภัยและเตรียมยาให้พร้อม"},
]
